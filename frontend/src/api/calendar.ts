...
import type { EventListItem, EventDetail, EventCreate, VoteCreate, Vote, ChoiceCreate, Choice } from '@/types/calendar'
...
export async function updateEvent(id: number, event: EventCreate): Promise<EventDetail> {
